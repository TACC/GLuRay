...
#
# $Date: 2002/09/25 16:43:20 $ $Revision: 1.1.1.1 $
# $Header: /cvsroot/spyglass/spyglass-gui/src/lib/specs/enum.spec,v 1.1.1.1 2002/09/25 16:43:20 mem Exp $
...
# VERSION_1_2 enum: (Promoted for OpenGL 1.2)
# WRAP_BORDER comes from WRAP_BORDER_SUN; is not in HP extension
...
# ARB_future_use: 0x84E8
# (0x84E7-0x84E8 previously used in a draft version of ARB_multisample,
#  but not in the final ARB-approved version)
...
# NVIDIA_future_use: 0x84F0-0x84F1
...
# NVIDIA_future_use: 0x84FB-0x84FC
...
# Any_vendor_future_use: 0x89A0-89FF

###############################################################################

# Apple: 0x8A00-0x8A7F (ARB_pipeline_program/ARB_vertex_program - tentative allocation to Bob Beretta)
...
# Any_vendor_future_use: 0x8A80-0xFFFF
#
