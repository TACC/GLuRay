...
void MGeometryGeneratorTriangles::addVertex(Real x, Real y, Real z)
{
...
void MGeometryGeneratorTriangles::addNormal(Real x, Real y, Real z)
{
  Mesh* _mesh = _data->mesh;
  //_mesh->vertexNormals.push_back(Vector(x,y,z));
}

void MGeometryGeneratorTriangles::addTextureCoord(Real u, Real v, Real w, Real z)
{
  Mesh* _mesh = _data->mesh;
...
void MGeometryGeneratorTriangleStrip::addTextureCoord(Real u, Real v, Real w, Real z) {
    Mesh* _mesh = _data->mesh;
    _mesh->texCoords.push_back(Manta::Vector(u,v,w));
  // cout << "adding texture coordinate: " << u << v<< w << endl;
}

void MGeometryGeneratorTriangleStrip::addVertex(Real x, Real y, Real z)
{
  Mesh* _mesh = _data->mesh;
  _mesh->vertices.push_back(Vector(x,y,z));
  size_t num_verts = _mesh->vertices.size();
...
void MGeometryGeneratorQuads::addVertex(Real x, Real y, Real z)
{
  Mesh* _mesh = _data->mesh;
  _mesh->vertices.push_back(Vector(x,y,z));
  size_t num_verts = _mesh->vertices.size();
...
void MGeometryGeneratorQuads::addTextureCoord(Real u, Real v, Real w, Real z)
{
...
void MGeometryGeneratorQuadStrip::addVertex(Real x, Real y, Real z)
{
  Mesh* _mesh = _data->mesh;
  _mesh->vertices.push_back(Vector(x,y,z));
  size_t num_verts = _mesh->vertices.size();
...
void MGeometryGeneratorQuadStrip::addTextureCoord(Real u, Real v, Real w, Real z)
{
  Mesh* _mesh = _data->mesh;
  _mesh->texCoords.push_back(Manta::Vector(u,v,w));
}
...
void MGeometryGeneratorLines::addVertex(Real x,Real y,Real z)
{
...
void MGeometryGeneratorLineStrip::addVertex(Real x,Real y,Real z)
{
  Group* group = _data->group;
  _vertCounter++;
  Vector vertex(x,y,z);
